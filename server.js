...
Recipes.create('spaghetti', ['pasta', 'sauce', 'parmesean cheese']);
Recipes.create('mashed potatoes', ['potatoes', 'butter', 'milk']);
...
// when the root of this route is called with GET, return
// all current Recipeitems by calling `Recipes.get()`
